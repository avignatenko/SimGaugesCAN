...
class AltimeterTests(BaseGaugeTest):
    ...
    def test_basic(self):
        self.send_command_2(port=0, payload=make_payload_float(0))
        time.sleep(1)
        self.send_command_2(port=0, payload=make_payload_float(-2000))  # why - ???
        time.sleep(1)
...
class TurnCoordinatorTests(BaseGaugeTest):
    ...
    def test_hor(self):
        self.send_command_2(port=1, payload=make_payload_float(-2))
        time.sleep(1)
        self.send_command_2(port=1, payload=make_payload_float(2))
        time.sleep(1)
        self.send_command_2(port=1, payload=make_payload_float(0))
...
class DirIndicatorTests(BaseGaugeTest):
    ...
    def test_hor(self):
        self.send_command_2(port=1, payload=make_payload_float(-30))
        time.sleep(1)
        self.send_command_2(port=1, payload=make_payload_float(30))
        time.sleep(1)
        self.send_command_2(port=1, payload=make_payload_float(0))
    ...
    def test_knob_manual_0(self):
        ...
        for msg in bus:
            if (
                ...
                and port_from_canid(msg.arbitration_id) == 0
            ):
                print(msg.data)
                break
    ...
    def test_knob_manual_1(self):
        ...
        for msg in bus:
            if (
                src_id_from_canid(msg.arbitration_id) == self.gauge_id
                and port_from_canid(msg.arbitration_id) == 1
            ):
                print(msg.data)
                break
...
class VertSpeedTests(BaseGaugeTest):
    ...
    def test_basic(self):
        self.send_command_2(port=0, payload=make_payload_float(-15))
        time.sleep(2)
        self.send_command_2(port=0, payload=make_payload_float(15))
        time.sleep(2)
        self.send_command_2(port=0, payload=make_payload_float(0))
...
class Indicators1Tests(BaseGaugeTest):
    ...
    def test_alt_amp(self):
        self.send_command_2(port=0, payload=make_payload_float(60))
        time.sleep(2)
        self.send_command_2(port=0, payload=make_payload_float(30))
        time.sleep(2)
        self.send_command_2(port=0, payload=make_payload_float(0))
    ...
    def test_oil_temp(self):
        self.send_command_2(port=1, payload=make_payload_float(200))
        time.sleep(2)
        self.send_command_2(port=1, payload=make_payload_float(100))
        time.sleep(2)
        self.send_command_2(port=1, payload=make_payload_float(0))

    def test_oil_press(self):
        self.send_command_2(port=2, payload=make_payload_float(90))
        time.sleep(2)
        self.send_command_2(port=2, payload=make_payload_float(60))
        time.sleep(2)
        self.send_command_2(port=2, payload=make_payload_float(0))

    def test_air_temp(self):
        self.send_command_2(port=3, payload=make_payload_float(-10))
        time.sleep(2)
        self.send_command_2(port=3, payload=make_payload_float(30))
        time.sleep(2)
        self.send_command_2(port=3, payload=make_payload_float(0))
...
class Indicators2Tests(BaseGaugeTest):
    ...
    def test_fuel_2(self):
        self.send_command_2(port=2, payload=make_payload_float(30))
        time.sleep(2)
        self.send_command_2(port=2, payload=make_payload_float(20))
        time.sleep(2)
        self.send_command_2(port=2, payload=make_payload_float(0))
    ...
    def test_fuel_press(self):
        self.send_command_2(port=1, payload=make_payload_float(50))
        time.sleep(2)
        self.send_command_2(port=1, payload=make_payload_float(14))
        time.sleep(2)
        self.send_command_2(port=1, payload=make_payload_float(0))
